...
crash_sound = pygame.mixer.Sound('./Lab15/crash.wav')
...
carImg = pygame.image.load('./Lab15/racecar.png')
gameIcon = pygame.image.load('./Lab15/racecar.png')
...
def game_loop():
    ...
    pygame.mixer.music.load('./Lab15/jazz.mp3')
